...
const PITCH_FRICTION_Z   = 0.98;         // along-pitch friction on bounce (preserves carry for slow deliveries)
...
const AIR_DRAG_PER_SEC   = 0.005;        // minimal air drag for slow deliveries
...
class GameEngine {
    ...
    bowl() {
        ...
        const baseSpeed = 4.2 + this.level * 0.25; // slow, comfortable delivery speed for easy reaction
